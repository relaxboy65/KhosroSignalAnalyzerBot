...
# =========================================================
# Helper: Structure with tolerance (tuple/list candles)
# candle format assumed: (open, high, low, close, ...)
# =========================================================
...
# =========================================================
# Helper: Healthy compressed range (4h pause before move)
# =========================================================
...
# =========================================================
# Helper: MACD very strong (real pressure, not memory)
# =========================================================
def macd_very_strong(macd_vals, direction):
    ...
    # 30m باید واقعاً در حال فشار دادن باشد
...
def check_rules_ultra_quality_flexible(analysis_data, direction):
    ...
    trend_4h = structure_with_tolerance(
    ...
    # ================= Rule 5: RSI =================
    rsi_ok, _, rsi_vals = rsi_count_ok(
